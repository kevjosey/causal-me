...
lines(a.vals, out_est[4,], type = "l", col = hue_pal()(6)[5], lwd = 2, lty = 1)
lines(a.vals, out_est[5,], type = "l", col = hue_pal()(6)[6], lwd = 2, lty = 1)
legend(5, 0.1, legend=c("True ERF","NAIVE","RC","LOESS","DR"),
